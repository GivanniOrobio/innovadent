function waitForElement(e, o = 20, t = 25) {
  return new Promise((a) => {
    let r = 0;
    const s = setInterval(() => {
      ((document.querySelector(e) || r >= o) && (clearInterval(s), a()), r++);
    }, t);
  });
}
window.config = {
  ...
  disableConfirmationPrompts: !0,
  showPatientInfo: "disabled",
  showLoadingIndicator: !0,
  activateViewportBeforeInteraction: !1,
            ...
            new Promise((e, o) => {
              const t = () => {
                ...
                if (a && a.offsetWidth > 0 && a.offsetHeight > 0) {
                  ...
                  window.innerWidth <= 768 ? setTimeout(e, 500) : o();
